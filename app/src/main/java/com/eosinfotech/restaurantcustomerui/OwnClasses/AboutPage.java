...
import com.eosinfotech.restaurantcustomerui.Utils.AboutPageUtils;
...
public class AboutPage {
    ...
    public AboutPage addEmail(String email, String title) {
        ...
        emailElement.setIconTint(R.color.colorPrimaryText);
    ...
    public AboutPage addPlayStore(String id, String title) {
        ...
        Uri uri = Uri.parse("https://play.google.com/store/apps/developer?id=" + id);
