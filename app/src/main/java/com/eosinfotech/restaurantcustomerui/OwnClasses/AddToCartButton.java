 ...
 * Created by Neelam.
 */
public class AddToCartButton extends RelativeLayout {
    ...
    public AddToCartButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        this.view = this;
        inflate(context, R.layout.addtocart_button, this);
        final Resources res = getResources();
        final int defaultColor = res.getColor(R.color.colorPrimaryText);
        final int defaultTextColor = res.getColor(R.color.colorHeadText);
        final Drawable defaultDrawable = res.getDrawable(R.drawable.elegant_ripple);
        ...
        textView = (BoldTextView) findViewById(R.id.number_counter);
    ...
    public interface OnValueChangeListener {
        void onValueChange(AddToCartButton view, int oldValue, int newValue);
    }
