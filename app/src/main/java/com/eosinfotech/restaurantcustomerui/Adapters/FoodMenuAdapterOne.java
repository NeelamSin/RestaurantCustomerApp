...
public class FoodMenuAdapterOne extends RecyclerView.Adapter<FoodMenuAdapterOne.CustomViewHolder> {
    ...
    public FoodMenuAdapterOne(List<FoodMenu> pizzas, Context mContext) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_horizontal_category_view, parent, false);
     ...
     */
    @Override
    public void onBindViewHolder(final FoodMenuAdapterOne.CustomViewHolder holder, int position) {
        ...
        Picasso.get().load(pizza.getImageResource()).networkPolicy(NetworkPolicy.NO_CACHE).memoryPolicy(MemoryPolicy.NO_CACHE).into(holder.image);
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public RelativeLayout relativeLayoutNew;
        ...
        public CustomViewHolder(View itemView) {
            super(itemView);
            name = (RegularTextView) itemView.findViewById(R.id.name);
            image = (ImageView) itemView.findViewById(R.id.thumbnail);
            relativeLayoutNew = (RelativeLayout) itemView.findViewById(R.id.clickLayout);
