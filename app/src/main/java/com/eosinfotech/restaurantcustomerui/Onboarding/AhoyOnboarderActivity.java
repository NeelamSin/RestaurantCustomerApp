package com.eosinfotech.restaurantcustomerui.Onboarding;
...
public abstract class AhoyOnboarderActivity extends AppCompatActivity implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView buttonSkipped = (TextView) findViewById(R.id.skippedButton);
        buttonSkipped.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoNext = new Intent(AhoyOnboarderActivity.this , LoginActivity.class);
