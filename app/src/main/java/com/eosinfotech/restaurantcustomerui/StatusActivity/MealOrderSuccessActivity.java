...
public class MealOrderSuccessActivity extends AppCompatActivity {
    ...
    private void fetchFCMDetailed() {
        new MealOrderSuccessActivity.FetchFCMDetailedToKitchen(MealOrderSuccessActivity.this).execute();
    }
    ...
    private class FetchFCMDetailedToKitchen extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String aBoolean) {
            ...
            {
                new MealOrderSuccessActivity.SendFcm(MealOrderSuccessActivity.this).execute(tokenarraylist.get(i),""+i);
            }
        }
    }
        ...
        protected void onPostExecute(String aBoolean) {
            ...
            if(Integer.parseInt(position)==(tokenarraylist.size()-1))
            {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        startCheckAnimation();
                        Intent intent=new Intent(MealOrderSuccessActivity.this,TableCategoryActivity.class);
