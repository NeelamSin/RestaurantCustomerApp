...
public class CashPaymentSuccessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            boolean result=new CashOrderPaymentAsyncTask(CashPaymentSuccessActivity.this).execute(
            ...
            {/*
                ...
                */
                ...
                Intent holding = new Intent(CashPaymentSuccessActivity.this  , TableClosedActivity.class);
    ...
    private class ReleaseTable extends AsyncTask<String, String, Boolean>
    {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            editor.putString("tableconfirmed", "");
            editor.commit();
            Intent intent=new Intent(CashPaymentSuccessActivity.this,TableCategoryActivity.class);
            startActivity(intent);
