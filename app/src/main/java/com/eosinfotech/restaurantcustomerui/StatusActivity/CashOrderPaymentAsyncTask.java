...
public class CashOrderPaymentAsyncTask extends AsyncTask<String, String, Boolean>
{
    ...
    public CashOrderPaymentAsyncTask(Context context) {
    ...
    protected Boolean doInBackground(String... params)
    {
        ...
        try {
            ...
            jsonObject.put("clientId",mContext
